...
export type PopupOption = "ok" | "confirm" | "boolean" | "message";
							...
							<View style={styles.options}>
								{type === "ok" && (
									<Button
										...
										onPress={
											onRespondOk ?? rest.onRequestClose
										}
										accentColor={
											caution
												? colors.critic
