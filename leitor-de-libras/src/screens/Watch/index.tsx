    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scroll}>
                <Font preset="title" style={styles.title} numberOfLines={2}>Título do vídeo Lorem ipsum, dolor sit amet consectetur adipisicing elit. Impedit, ducimus.</Font>
                <FlatList
